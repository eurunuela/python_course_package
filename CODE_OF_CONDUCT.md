...
[Code of Conduct Enforcement Team](https://workout_analysis.readthedocs.io/en/stable/governance.html#leadership):
...
necessary for the safety of the `workout_analysis` community, including but not
limited to:
...
* asking a contributor to no longer participate in the development of `workout_analysis`

For more details on the enforcement process, please see our documentation
on [governance](https://workout_analysis.readthedocs.io/en/stable/governance.html).
