...
[Code of Conduct Enforcement Team](https://package-template.readthedocs.io/en/stable/governance.html#leadership):
...
necessary for the safety of the `package-template` community, including but not
limited to:
...
* asking a contributor to no longer participate in the development of `package-template`

For more details on the enforcement process, please see our documentation
on [governance](https://package-template.readthedocs.io/en/stable/governance.html).
