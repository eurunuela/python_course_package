...
[Code of Conduct Enforcement Team](https://python_course.readthedocs.io/en/stable/governance.html#leadership):
...
necessary for the safety of the `python_course` community, including but not
limited to:
...
* asking a contributor to no longer participate in the development of `python_course`

For more details on the enforcement process, please see our documentation
on [governance](https://python_course.readthedocs.io/en/stable/governance.html).
